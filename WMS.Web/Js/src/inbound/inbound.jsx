            ...
            <div>
                <div className="panel panel-default">
                    <div className="panel-body">
                         ...
                         <div className="row">
                            <div className="col-md-1">Inhouse No:</div>
                            <div className="col-md-10">{this.props.data.DocNo}</div>
                         </div>
                         <div className="row">
                            <div className="col-md-1">Wip No:</div>
                            <div className="col-md-10">{this.props.data.WipNo}</div>
                         </div>
                         <div className="row">
                            <div className="col-md-1">Part Number:</div>
                         ...
                         <div className="row">
                            <div className="col-md-1">DestPlant:</div>
                            <div className="col-md-10">{this.props.data.DestPlant}</div>
                         </div>
                         <div className="row">
                            <div className="col-md-1">DestLocation:</div>
                            <div className="col-md-10">{this.props.data.DestLocation}</div>
                         </div>
                    </div>
                </div>
